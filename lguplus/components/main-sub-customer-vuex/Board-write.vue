          ...
          <b-table-simple class="c-table-row c-all-white">
            ...
            <b-tbody>
              <b-tr>
                ...
                <b-td>
                  <ValidationProvider v-slot="{ errors, classes }" rules="required|max:10" :mode="veeMode" slim>
              ...
              <b-tr>
                ...
                <b-td>
                  <div class="c-inpform-group column-email">
                    <ValidationProvider v-slot="{ errors, classes }" rules="required" :mode="veeMode" slim>
                      <div class="c-inpform" :class="classes">
              ...
              <b-tr>
                ...
                <b-td>
                  <div class="c-inpform-group column-telnumber">
                    ...
                    <ValidationProvider v-slot="{ errors, classes }" :rules="{ regex: /([0-9]{3,4})-?([0-9]{4})$/ }" :mode="veeMode" slim>
                      <div class="c-inpform" :class="classes">
...
export default {
  ...
  methods: {
    ...mapMutations([]),
    ...mapActions(['BOARD_WRITE_ACTION', 'CNT_PLUS_ACTION']),
    // --------------------------------------------------------------[init]
    dataInit() {
    ...
    async onSubmit() {
      ...
      if (!isValid) {
        ...
        await this.BOARD_WRITE_ACTION(dataObj);
        await this.CNT_PLUS_ACTION(++this.totCnt);
