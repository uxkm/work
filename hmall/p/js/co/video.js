...
function videojs(id, options, ready) {
  ...
  player.one("loadedmetadata", function(){
    jQuery(this.el_.querySelector('.vjs-big-play-button'))
      .after('<span class="vjs-custom-duration">'+parseInt(this.duration()).toTimeFormat('mm:ss')+'</span>')
      console.log(jQuery(this.el_.querySelector('.vjs-big-play-button')));
  });
  return player;
}
