...
$(document).ready(function($){
  ...
  // Dropdown Menu
  $.navigation.on('click', '.nav-dropdown-toggle', function(e){
...
/*    if ($.ajaxLoad) {
  ...
  $('.sidebar-toggler').click(function(){
    ...
    var on = $('#sidebar-toggler-on');
    var off = $('#sidebar-toggler-off');
    var sideWidth = sidemenu.width();
    if (sidemenu.css('margin-left') == '0px') {
      sidemenu.css('margin-left',-sideWidth);
      on.prop('hidden', false);
      off.prop('hidden', true);
      $('.sidebar-fixed .main').css('margin-left','0px');
      $('.sidebar-fixed .app-footer').css('margin-left','0px');
    } else {
    	on.prop('hidden', true);
    	off.prop('hidden', false);
      $('.sidebar-fixed .main').css('margin-left',sideWidth+'px');
      $('.sidebar-fixed .app-footer').css('margin-left',sideWidth+'px');
