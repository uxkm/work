...
(function ($) {
     ...
     * @param  encoding  (string, optional) the encoding to request for bundles. Property file resources bundles are specified to be in ISO-8859-1 format. Defaults to UTF-8 for backward compatibility.
    ...
    $.i18n.properties = function (settings) {
        ...
        if (settings.language.indexOf('ko') > -1) {
          settings.language = '';
        }
        ...
        files.forEach(function (file) {
            ...
            if (settings.version) {
                defaultFileName += '?version=' + settings.version;
            }
            ...
            if (shortCode) {
              shortFileName = settings.path + file + '_' + shortCode + '.properties';
                if (settings.version) {
                    shortFileName += '?version=' + settings.version;
                }
            ...
            if (settings.language.length >= 5) {
                ...
                if (settings.version) {
                    longFileName += '?version=' + settings.version;
                }
    ...
    $.message = function (key /* Add parameters as function arguments as necessary  */) {
